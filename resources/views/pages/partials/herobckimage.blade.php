<section class="bg-cover bg-center h-screen md:py-0" style="background-image: url('{{ Storage::url($block['data']['media']) }}');">
    <div class="flex items-center justify-center h-full bg-gray-900 bg-opacity-50">
        <div class="text-center">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white dark:text-white">{{ $block['data']['title'] }}</h1>
